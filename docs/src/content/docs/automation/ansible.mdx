...
For some sites, like my blog, this role also creates a directory for serving media files.

This is a temporary solution until I get a storage bucket sorted out.
